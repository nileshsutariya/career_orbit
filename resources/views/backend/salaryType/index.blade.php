        ...
        <div class="col-md-4">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="float-end">
                        <a href="{{ route('salaryType.index') }}" class="btn btn-primary"><i class="fa fa-plus"></i>{{
                            __('create') }}
                        </a>
                    </div>
                </div>
                <div class="card-body">
                    <form class="row g-3" action="{{ route('salaryType.update', $salaryType_id->id) }}" method="POST">
                        @method('PUT')
                        @csrf
                        @foreach ($app_language as $key => $language)
                        @php
