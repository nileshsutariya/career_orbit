                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="form-group col-md-2 mb-2">
                                        <a role="button" onclick="add_features_field()"
                                            class="btn bg-primary text-light"><i class="fa fa-plus"></i></a>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6 mb-2">
                                    ...
                                    <select name="organization_type_id"
                                        class="form-control select2 {{ error('organization_type_id') }}"
                                ...
                                <div class="form-group col-md-6 mb-2">
                                    ...
                                    <select name="industry_type_id"
                                        class="form-control select2 {{ error('industry_type_id') }}"
                                        id="organization_type_id">
            ...
            <div class="row justify-content-center">
                ...
                <div class="form-group col-md-2">
                    <a role="button" id="remove_item"
                        class="btn bg-danger text-light"><i class="fa fa-times"></i></a>
                </div>
            </div>
            `);
        }
