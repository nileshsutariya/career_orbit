                                        ...
                                        <ul class="recent">
                                            <div class="row d-flex border-bottom">
                                                <li class="d-flex align-items-center col-md-4">
                                                    <div class="flex-shrink-0 m-r-10"> <x-svg.details-calendar-blank />
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <h5> {{ __('establishment_date') }}</h5>

                                                        <p> <strong>{{ $company->establishment_date ? date('j F, Y', strtotime($company->establishment_date)) : '' }}
                                                            </strong> </p>
                                                    </div>
                                                </li>

                                                <li class="d-flex align-items-center col-md-4">
                                                    <div class="flex-shrink-0 m-r-10"> <x-svg.details-users /> </div>
                                                    <div class="flex-grow-1">
                                                        <h5> {{ __('team_size') }}</h5>

                                                        <p> <strong>{{ $company->team_size ? $company->team_size->name : '' }}</strong>
                                                        </p>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="d-flex align-items-center col-md-4">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <h5> {{ __('industry_type') }}</h5>

                                                        <p> <strong>{{ $company->industry ? $company->industry->name : '' }}
                                                            </strong> </p>
                                                    </div>
                                                </li>
                                            </div>
                                            <div class="row d-flex border-bottom">
                                                <li class="d-flex align-items-center col-md-4">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        ...
                                                        <p> <strong>{{ $company->country ? $company->country : '' }}
                                                            </strong>
                                                        </p>
                                                    </div>
                                                </li>
                                                ...
                                                <li class="d-flex align-items-center col-md-4">
                                                    <div class="flex-shrink-0 m-r-10"> <x-svg.details-phone-call />
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <h5> {{ __('phone') }}</h5>

                                                        <p> <strong> <a
                                                                    href="tel: {{ $company->user->contactInfo->phone }}">{{ $company->user->contactInfo->phone }}</a>
                                                            </strong> </p>
                                                    </div>
                                                </li>
                                            </div>
                                            <div class="row d-flex">
                                                <li class="d-flex align-items-center col-md-4">
                                                    @if ($company->user->contactInfo->email)
                                                        <div class="flex-shrink-0 m-r-10"> <x-svg.details-envelop
                                                                stroke="#0A65CC" fill="#0A65CC" /></div>
                                                        <div class="flex-grow-1">
                                                            <h5> {{ __('contact_email') }}</h5>
                                                            <p> <strong> <a
                                                                        href="mailto: {{ $company->user->contactInfo->email }}">{{ $company->user->contactInfo->email }}
                                                                    </a>
                                                                </strong>
                                                            </p>
                                                        </div>
                                                ...
                                                <tr>
                                                                ...
                                                                @if ($job->status == 'active' || $job->status == 'expired')
                                                                    <form
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <label class="custom-control-label"
                                                                                for="status_input_unpublish_{{ $job->id }}">{{ __('unpublish') }}</label>
                                                                        </div>
                                                                    </form>
                                                                @endif
                                                            </div>
                                                    ...
                                                    <td>
                                                        <a data-toggle="tooltip" data-placement="top"
                                                            ...
                                                            class="btn ll-p-0">{{ __('view_details') }}
