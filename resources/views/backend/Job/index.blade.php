                                ...
                                <tr>
                                    ...
                                    <td >
                                        <a href="{{ route('job.show', $job->id) }}" class="company">
                                            @if ($job->company)
                                            <img src="{{ asset($job->company->logo_url) }}" class="img-fluid table-avtar" alt="image">
                                            @else
                                            ...
                                            <div>
                                                ...
                                                <p>
                                                    ...
                                                    <span>{{ $job->company && $job->company->user ?
                                                        $job->company->user->name : $job->company_name }}</span>
                                                    <span>·</span>
                                    ...
                                    <td tabindex="0">
                                        ...
                                        @endphp
                                        @if ($job->deadline <= $formattedDateTime) {{ date('j F, Y', strtotime($job->
                                            deadline)) }}
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <form action="{{ route('admin.job.status.change', $job->id) }}"
                                                ...
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    ...
                                                    <label class="custom-control-label"
                                                        for="status_input_pending_{{ $job->id }}">{{ __('pending')
                                                        }}</label>
                                                </div>
                                            </form>
                                            @endif
                                            ...
                                            <form action="{{ route('admin.job.status.change', $job->id) }}"
                                                ...
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    ...
                                                    <label class="custom-control-label"
                                                        for="status_input_publish_{{ $job->id }}">{{ __('publish')
                                                        }}</label>
                                                </div>
                                            </form>
                                            @endif
                                            ...
                                            <form action="{{ route('admin.job.status.change', $job->id) }}"
                                                ...
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    ...
                                                    <label @if ($job->status == 'expired') class="custom-control-label
                                                        expired_radio" @else class="custom-control-label " @endif
                                                        data-bs-toggle="tooltip"
                                                        title="{{ __('expired_status_depend_on_deadline') }}"
                                                        for="status_input_unpublish_{{ $job->id }}">{{ __('expired')
                                                        }}</label>
                                                </div>
                                            </form>
                                            @endif
                                    ...
                                    @endif
                                    <td>
                                        <a data-bs-toggle="tooltip" data-placement="top" title="{{ __('details') }}"
                                            href="{{ route('job.show', $job->id) }}"
                                            class="btn ll-btn ll-border-none">{{ __('view_details') }}
                                            <x-svg.table-btn-arrow />
                                        </a>
                                        <a data-bs-toggle="tooltip" data-placement="top" title="{{ __('clone') }}"
                                        ...
                                        <a data-bs-toggle="tooltip" data-placement="top" title="{{ __('edit') }}"
                                            href="{{ route('job.edit', $job->id) }}" class="btn ll-mr-4 ll-p-0">
                                            <x-svg.table-edit />
                                        </a>
                                        @endif
...
<div class="modal fade" id="bulk_import_modal" tabindex="-1" role="dialog" aria-labelledby="bulk_import_modalTitle"
    aria-hidden="true">
