                        ...
                        <div class="pt-1 pb-4">
                            ...
                            <div class="row form-group">
                                <div class="col-md-4">
                                    ...
                                    <select class="form-control select2" id="company" disabled>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-control select2" id="category" disabled>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-control select2" id="job_role" disabled>
                            ...
                            <div class="row form-group">
                                <div class="col-6">
                                    ...
                                    <select class="form-control select2" id="experience" disabled>
