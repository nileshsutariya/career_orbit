                            ...
                            <div class="card mb-0">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row" id="company-input-container">
                                        <div class="col-sm-12 mb-2" id="company-input-select">
                                        ...
                                        <div class="col-sm-12 col-md-12 d-none mt-2 mb-2" id="apply_email_div">
                                        ...
                                        <div class="col-sm-12  mb-2 hidden" id="company_name_container">
                                    ...
                                    <div class="row ">
                                        ...
                                        <div class="col-sm-6 mb-2 ">
                                            ...
                                            <select name="salary_type"
                                                class="form-control select2 @error('salary_type') is-invalid @enderror"
                                    ...
                                    <div class="row ">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="job_type"
                                                class="form-control select2 @error('job_type') is-invalid @enderror"
