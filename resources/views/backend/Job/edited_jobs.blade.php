            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between">
                        ...
                        <div>
                            <a href="{{ route('job.index') }}" class="btn bg-primary"><i class="fa fa-arrow-left mr-1"></i>
                ...
                <form id="formSubmit" action="{{ route('admin.job.edited.index') }}" method="GET"
                    ...
                    <div class="card-body row">
                        ...
                        <div class="col-2">
                            ...
                            <select name="job_category" class="form-control select2 w-100-p">
                                <option value="">
                                    {{ __('all') }}
                                </option>
                        ...
                        <div class="col-2">
                            ...
                            <select name="job_type" class="form-control select2 w-100-p">
                                <option value="">
                                    {{ __('all') }}
                                </option>
                        ...
                        <div class="col-2">
                            ...
                            <select name="experience" class="form-control select2 w-100-p">
                                <option value="">
                                    {{ __('all') }}
                                </option>
