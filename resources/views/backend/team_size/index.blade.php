                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    @if (userCan('team_sizes.delete'))
                                                        <form action="{{ route('teamSize.destroy', $team->id) }}"
                ...
                @if (!empty($team_size) && userCan('team_sizes.update'))
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="float-end">
                                <a href="{{ route('teamSize.index') }}" class="btn btn-primary"><i
                        ...
                        <div class="card-body">
                            <div class="card-wrapper border rounded-3">
                                ...
                                <form class="row g-3" action="{{ route('teamSize.update', $team_size->id) }}"
                                    method="POST">
                                    @method('PUT')
                                    @csrf
