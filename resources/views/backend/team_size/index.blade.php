...
<div class="container-fluid">
    <div class="row">
                ...
                <div class="card-header pb-0 card-no-border">
                    <div class="d-flex justify-content-between flex-sm-row flex-column">
                        <div class="pb-3 pb-md-0">
                            <h4 class="title">{{ __('team_size_list') }}
                                ({{ count($team_sizes) }})</h4>
                        </div>
                    </div>
                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a href="{{ route('teamSize.edit', $team->id) }}" class="btn">
        ...
        <div class="col-md-4">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="float-start">
                        <h4>{{ __('edit') }} {{ __('team_size') }}</h4>
                    </div>
                    <div class="float-end">
                        <a href="{{ route('teamSize.index') }}" class="btn btn-primary"><i class="fa fa-plus"></i>{{
                            __('create') }}
                        </a>
                    </div>
                </div>
                <div class="card-body">
                    <form class="row g-3" action="{{ route('teamSize.update', $team_size->id) }}" method="POST">
                        @method('PUT')
                        @csrf
            ...
            <div class="card">
                <div class="card-header">
                    <h4>{{ __('create') }}{{ __('team_size') }}</h4>
                </div>
                <div class="card-body">

                    @if (userCan('job_role.create'))
                    <form class="row g-3" action="{{ route('teamSize.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="col-12">
                            <button class="btn btn-primary" type="submit"><i class="fa fa-plus"></i> {{ __('save') }}
                            </button>
                        </div>
                    </form>
                    @else
