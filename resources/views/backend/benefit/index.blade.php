                ...
                <div class="card-header pb-0 card-no-border">
                    <div class="d-flex justify-content-between flex-sm-row flex-column">
                        <div class="pb-3 pb-md-0">
                            <h4 class="title">{{ __('benefit_list') }} {{ count($benefits) }}</h4>
                        </div>
                    </div>
                </div>
                                    ...
                                    <td>
                                        ...
                                        <div>
                                            ...
                                            <span class="d-block"><b>{{ getLanguageByCodeInLookUp($translation->locale,
                                                    $app_language) }}</b>: {{ $translation->name }} </span>
                                            @endif
                                            @endforeach
                                        </div>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a href="{{ route('benefit.edit', $item->id) }}" class="btn"><i
                                                    class="fa fa-edit fa-2x txt-success"> </i></a>
                                            @endif
                                            ...
                                            <form action="{{ route('benefit.destroy', $item->id) }}" method="POST">
                                                ...
                                                <button
                                                    ...
                                                    class="btn"><i class="fa fa-trash-o fa-2x txt-danger"></i>
                                                </button>
                                            </form>
                                            @endif
                                        </div>
        ...
        <div class="col-md-4">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="float-end">
                        <a href="{{ route('benefit.index') }}" class="btn btn-primary"><i class="fa fa-plus"></i>{{
                            __('create') }}
                        </a>
                    </div>
                </div>
