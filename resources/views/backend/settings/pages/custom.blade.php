...
<div class="alert alert-warning mb-3">
    ...
    <a target="_blank" href="https://search.google.com/search-console"> {{ __('google_search_console') }} </a>,
    <a target="_blank" href="https://analytics.google.com/"> {{ __('google_analytics') }}</a>,
    <a target="_blank" href="https://www.facebook.com/business/tools/meta-pixel"> {{ __('facebook_pixel') }}</a>,
    <a target="_blank" href="https://www.hubspot.com/">{{ __('hubspot_verification') }}</a>,
    <a target="_blank" href="https://zoho.com">{{ __('zoho_verification') }}</a>,
    <a target="_blank" href="https://help.pinterest.com/en/business/article/claim-your-website"> {{
                ...
                <form action="{{ route('settings.custom.update') }}" method="post">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <textarea name="header_css" id="headerCss"
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="header_script" id="headerScript"
                                class="form-control @error('name') is-invalid @enderror"
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="body_script" id="bodyScript"
                                class="form-control @error('name') is-invalid @enderror"
