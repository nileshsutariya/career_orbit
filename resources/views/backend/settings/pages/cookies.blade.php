                    ...
                    <div class="col">
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <input class="tgl tgl-flip" data-bootstrap-switch value="1" name="allow_cookies"
                                    id="cb1" type="checkbox" {{ $cookie->allow_cookies ? 'checked' : '' }}
                                    data-size="large">
                        ...
                        <div class="mb-3 row">
                            <label class="col-sm-3" for="cookie_expiration">{{ __('cookie_expiration_day') }}<span
                                    class="text-danger">*</span></label>
                            <div class="col-sm-9">
                                <input class="form-control digits" type="number" max="365" id="cookie_expiration"
                                    name="cookie_expiration" placeholder="{{ __('enter_cookie_expiration_day') }}"
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <input class="tgl tgl-flip" data-bootstrap-switch value="1" name="force_consent"
                                    id="cb2" type="checkbox" {{ $cookie->force_consent ? 'checked' : '' }}
                                    data-size="large">
