                        ...
                        <div class="form-group row mb-2">
                            ...
                            <div class="col-sm-7">
                                <select name="job_limit" id="careerjet_job_limit"
                                    ...
                                    <option {{ config('templatecookie.careerjet_limit') == 10 ? 'selected' : '' }}
                                        value="10">
                                        10
                                    </option>
                                    <option {{ config('templatecookie.careerjet_limit') == 15 ? 'selected' : '' }}
                                        value="15">
                                        15
                                    </option>
                                    <option {{ config('templatecookie.careerjet_limit') == 20 ? 'selected' : '' }}
                                        value="20">
                                        20
                                    </option>
                                    <option {{ config('templatecookie.careerjet_limit') == 50 ? 'selected' : '' }}
                                        value="50">
                                        50
                                    </option>
                                </select>
                ...
                <div class="card-header ">
                    <div class="d-flex justify-content-between">
                        <h3 class="card-title">
                            {{ __('indeed_api') }}
                            (<small><a target="_blank"
                                    href="https://indianaffiliateprograms.com/affiliate-programs/indeed">
                                    Become an affiliate partner
                                </a></small>)
                        </h3>
                    </div>
