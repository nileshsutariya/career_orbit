...
<div class="row">
    <div class="col-xl-6 col-lg-12">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input value="{{ config('app.name') }}" name="name" type="text" class="form-control "
                                    placeholder="{{ __('app_name') }}" id="site_name">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input value="{{ $setting->email }}" name="email" type="text" class="form-control "
                                    placeholder="{{ __('email') }}" id="site_email">
                            </div>
                        </div>
                    </div>
                    <div class="row mb-2">
            ...
            <div class="card-header">
                <div class="d-flex justify-content-between">
                    <h3 class="card-title line-height-36">
                        ...
                        (<small><a href="https://support.google.com/recaptcha" target="_blank">{{ __('get_help')
                                }}</a></small>)
                    </h3>
                </div>
            </div>
                    ...
                    <div class="form-group row mb-2">
                        ...
                        <div class="col-sm-7">
                            <input {{ config('captcha.active') ? 'checked' : '' }} type="checkbox" name="status"
                                data-bootstrap-switch value="1" data-on-text="{{ __('on') }}" data-off-color="default"
        ...
        <div class="card">
            ...
            <form class="form-horizontal" action="{{ route('settings.pusher.update') }}" method="POST" id="pusher_form">
                @method('PUT')
                @csrf
                <div class="card-body">
                    <div class="form-group row mb-2">
                    ...
                    <div class="form-group row mb-2">
                        ...
                        <div class="col-sm-7">
                            <input value="{{ old('pusher_app_cluster', config('templatecookie.pusher_app_cluster')) }}"
            ...
            <form class="form-horizontal" action="{{ route('settings.analytics.update') }}" method="POST"
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row mb-2">
                        ...
                        <div class="col-sm-7">
                            <input {{ old('is_analytics_active') ?? config('templatecookie.google_analytics_status')
                                ? 'checked' : '' }} type="checkbox" name="is_analytics_active" data-bootstrap-switch
                                value="1" data-on-text="{{ __('on') }}" data-off-color="default" data-on-color="success"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <div>
                                    ...
                                    <input type="checkbox" id="email_verification" {{ $setting->email_verification ?
                                    'checked' : '' }} name="email_verification"
                            ...
                            <div class="form-group mb-2">
                                ...
                                <div>
                                    ...
                                    <input type="checkbox" id="job_approval" {{ $setting->job_auto_approved ? 'checked'
                                    : '' }} name="job_approval"
                                    data-on-color="success" data-bootstrap-switch
                        ...
                        <div class="col-md-6 mt-2">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <div>
                                    ...
                                    <input type="checkbox" id="language_changing" {{ $setting->language_changing ?
                                    'checked' : '' }} name="language_changing"
                                    data-on-color="success" data-bootstrap-switch
                                    data-on-text="{{ __('on') }}" data-off-color="default"
                                    data-off-text="{{ __('off') }}" data-size="small" value="1">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <div>
                                    ...
                                    <input type="checkbox" id="currency_switcher" {{ $setting->currency_switcher ?
                                    'checked' : '' }} name="currency_switcher"
                                    data-on-color="success" data-bootstrap-switch
                                    data-on-text="{{ __('on') }}" data-off-color="default"
                                    data-off-text="{{ __('off') }}" data-size="small" value="1">
                            ...
                            <div class="form-group mb-2">
                                <x-forms.label class="mt-2" name="employer_account_auto_activation" :required="true" />
                                <div>
                            ...
                            <div class="form-group mb-2">
                                <x-forms.label class="mt-1" name="candidate_account_auto_activation" :required="true" />
                                <div>
                        ...
                        <div class="col-sm-8">
                            <div class="custom-control custom-radio custom-control-inline">
                                <input onclick="changeMapType()" type="radio" id="leaflet-map" name="map_type"
                                    class="custom-control-input" value="leaflet" {{ $setting->default_map == 'leaflet' ?
                                'checked' : '' }}>
                            ...
                            <div class="custom-control custom-radio custom-control-inline">
                                <input onclick="changeMapType()" type="radio" id="google-mapp" name="map_type"
                                    class="custom-control-input" value="google-map" {{ $setting->default_map ==
                                'google-map' ? 'checked' : '' }}>
                    ...
                    <div class="form-group row mb-2">
                        ...
                        <div class="col-sm-8">
                            <div class="custom-control custom-radio custom-control-inline">
                                ...
                                <label class="custom-control-label" for="single-country-base">{{ __('single_base')
                                    }}</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline">
