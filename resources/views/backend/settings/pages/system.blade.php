            ...
            <div class="row">
                        ...
                        <div class="col-sm-9">
                            ...
                            <span class="help-text">{{ __('live_mode_enable_url') }}
                                <span class="badge badge-dark">
                                    {{ config('templatecookie.maintenance_disable_url') }}
                                </span>
                            </span>
                        </div>
                        @if (userCan('setting.update'))
                        ...
                        <div class="col-sm-9">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="search_engine_indexing"
                                    id="search_engine_indexing" value="1"
                                    @if ($setting->search_engine_indexing == 1) checked @endif>
                                <label class="form-check-label"
                ...
                <form action="{{ route('settings.google.analytics') }}" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7 col-md-4">
                            <input value="{{ config('templatecookie.google_analytics') }}" name="google_analytics_id"
                ...
                <form action="{{ route('settings.facebook.pixel') }}" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7 col-md-4">
                            <input value="{{ config('templatecookie.fb_pixel') }}" name="facebook_pixel_id"
                                type="text" class="form-control @error('facebook_pixel_id') is-invalid @enderror"
                                autocomplete="off">
                    ...
                    <div class="form-group">
                        <div class="col-sm-9">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="facebook_pixel"
                                    id="facebook_pixel" value="1" @if ($setting->facebook_pixel == 1) checked @endif>
