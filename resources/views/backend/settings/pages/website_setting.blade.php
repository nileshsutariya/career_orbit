        ...
        <div class="row">
            <div class="col-12 col-sm-12 col-md-2">
                <ul class="nav nav-pills flex-column">
                    <li class="nav-item border rounded mb-1">
                        <a class="nav-link {{ $tab_part == 'home' ? 'active' : '' }}" data-bs-toggle="tab"
                            href="#home">{{ __('home') }}</a>
                    </li>
                    <li class="nav-item border rounded mb-1">
                        <a class="nav-link {{ $tab_part == 'about' ? 'active' : '' }}" data-bs-toggle="tab"
                            href="#about">{{ __('about') }}</a>
                    </li>
                    <li class="nav-item border rounded mb-1">
                        <a class="nav-link {{ $tab_part == 'auth' ? 'active' : '' }}" data-bs-toggle="tab"
                            href="#authpage">{{ __('log_in') }} & {{ __('registration') }}</a>
                    </li>
                    <li class="nav-item border rounded mb-1">
                        <a class="nav-link {{ $tab_part == 'error' ? 'active' : '' }}" data-bs-toggle="tab"
                            href="#errorpage">{{ __('error_pages') }}</a>
                    </li>
                    <li class="nav-item border rounded mb-1">
                        <a class="nav-link {{ $tab_part == 'terms' ? 'active' : '' }}" data-bs-toggle="tab"
                            href="#termsandcondition">{{ __('terms_condition') }}</a>
                    </li>
                    <li class="nav-item border rounded mb-1">
                        <a class="nav-link {{ $tab_part == 'privacy' ? 'active' : '' }}" data-bs-toggle="tab"
                            href="#privary_policy">{{ __('privacy_policy') }}</a>
                    </li>
                    <li class="nav-item border rounded mb-1">
                        <a class="nav-link {{ $tab_part == 'refund' ? 'active' : '' }}" data-bs-toggle="tab"
                            href="#refund_policy">{{ __('refund_policy') }}</a>
                    </li>
                    <li class="nav-item border rounded mb-1">
                        <a class="nav-link {{ $tab_part == 'coming_soon' ? 'active' : '' }}" data-bs-toggle="tab"
                            href="#comingsoon">{{ __('comingsoon') }}</a>
                    </li>
                    <li class="nav-item border rounded mb-1">
                        <a class="nav-link {{ $tab_part == 'maintenance' ? 'active' : '' }}" data-bs-toggle="tab"
                            href="#maintenance_mode">{{ __('maintenance_mode') }}</a>
                    </li>
                    <li class="nav-item border rounded mb-1">
                        <a class="nav-link {{ $tab_part == 'pricing_plan' ? 'active' : '' }}" data-bs-toggle="tab"
                            href="#pricing_plan">{{ __('pricing_plan') }}</a>
                    </li>
                    <li class="nav-item border rounded mb-1">
                        <a class="nav-link {{ $tab_part == 'others' ? 'active' : '' }}" data-bs-toggle="tab"
            ...
            <div class="col-12 col-sm-12 col-md-10">
                <div class="tab-content no-padding">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            ...
                                            <input name="home_page_banner_image"
                                                data-allowed-file-extensions="jpg png svg jpge" data-min-width="250"
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row row-cols-md-3">
                                        <div class="col-sm-3">
                                            <div class="card-body">
                                                {{-- <input name="about_brand_logo" data-min-width="250" type="file"
                                                ...
                                                <p
                                                    ...
                                                    Recommended Image Size: 198x45</p>
                                                @if ($cms_setting->about_brand_logo)
                                                <a href="{{ route('settings.aboutLogo.delete', 'about_brand_logo') }}"
                                        ...
                                        <div class="col-sm-3">
                                            <div class="card-body">
                                                <input name="about_brand_logo1" type="file" class="form-control dropify"
                                                ...
                                                <a href="{{ route('settings.aboutLogo.delete', 'about_brand_logo1') }}"
                                                    onclick="return confirm('{{ __('are_you_sure') }}')"
                                                    class="tw-underline">
                                                    <small>{{ __('delete_image') }}</small>
                                                </a>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="card-body">
                                                <input name="about_brand_logo2" type="file" class="form-control dropify"
                                                ...
                                                <a href="{{ route('settings.aboutLogo.delete', 'about_brand_logo2') }}"
                                                    onclick="return confirm('{{ __('are_you_sure') }}')"
                                                    class="tw-underline">
                                                    <small>{{ __('delete_image') }}</small>
                                                </a>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="card-body">
                                                <input name="about_brand_logo3" type="file" class="form-control dropify"
                                                ...
                                                <a href="{{ route('settings.aboutLogo.delete', 'about_brand_logo3') }}"
                                                    onclick="return confirm('{{ __('are_you_sure') }}')"
                                                    class="tw-underline">
                                                    <small>{{ __('delete_image') }}</small>
                                                </a>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="card-body">
                                                <input name="about_brand_logo4" type="file" class="form-control dropify"
                                                ...
                                                <a href="{{ route('settings.aboutLogo.delete', 'about_brand_logo4') }}"
                                                    onclick="return confirm('{{ __('are_you_sure') }}')"
                                                    class="tw-underline">
                                                    <small>{{ __('delete_image') }}</small>
                                                </a>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="card-body">
                                                <input name="about_brand_logo5" type="file" class="form-control dropify"
                                                ...
                                                <a href="{{ route('settings.aboutLogo.delete', 'about_brand_logo5') }}"
                                                    onclick="return confirm('{{ __('are_you_sure') }}')"
                                                    class="tw-underline">
                                                    <small>{{ __('delete_image') }}</small>
                                                </a>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row row-cols-md-3">
                                        <div class="col-sm-3">
                                            <div class="card-body">
                                                <input name="about_banner_img" data-min-width="250" type="file"
                                                    class="form-control dropify"
                                        ...
                                        <div class="col-sm-3">
                                            <div class="card-body">
                                                <input name="about_banner_img1" data-min-width="250" type="file"
                                                    class="form-control dropify"
                                        ...
                                        <div class="col-sm-3">
                                            <div class="card-body">
                                                <input name="about_banner_img2" data-min-width="250" type="file"
                                                    class="form-control dropify"
                                        ...
                                        <div class="col-sm-3">
                                            <div class="card-body">
                                                <input name="about_banner_img3" data-min-width="250" type="file"
                                                    class="form-control dropify"
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <input name="login_page_image" type="file" class="form-control dropify"
                                                data-default-file="{{ asset($cms_setting->login_page_image) }}">
                                        </div>
                                        <div class="col-sm-6">
                                            <label>{{ __('register_image') }}</label>
                                            <input name="register_page_image" type="file" class="form-control dropify"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <form class="form-horizontal"
                                    action="{{ route('settings.errorpage.update', $cms_setting->id) }}" method="POST"
                                    enctype="multipart/form-data">
                                    @method('PUT')
                                    @csrf
                                    ...
                                    <div class="col-7">
                                        <form id="terms-form" action="{{ route('admin.privacy.terms.update') }}"
                                            ...
                                            <div class="form-group mb-2">
                                                <div class="row d-flex justify-content-between items-align-center mb-2">
                                                    <div class="col-4">
                                                        ...
                                                        <select id="translation_code" name="translation_code"
                                                            class="form-control select2 w-100 @error('translation_code') is-invalid @enderror">
                                                            @foreach ($languages as $key => $language)
                                                            <option {{ session()->get('terms_condition_page') ==
                                                ...
                                                <textarea id="editor2"
                                                    class="form-control {{ $errors->has('terms_page') ? 'is-invalid' : '' }}"
                                                    rows="5"
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="d-flex justify-items-center">
                                                            ...
                                                            <form action="{{ route('settings.cms.content.destroy') }}"
                                                                method="POST" class="d-inline">
                                                                @method('DELETE')
                                                                @csrf
                                            ...
                                            <div class="form-group mb-2">
                                                <div class="row d-flex justify-content-between items-align-center mb-2">
                                                    <div class="col-4">
                                                        ...
                                                        : loadDefaultLanguage();
                                                        @endphp
                                                        <select id="privary_policy_page_content" name="translation_code"
                                                            class="form-control select2 w-100  @error('translation_code') is-invalid @enderror">
                                                            @foreach ($languages as $key => $language)
                                                            <option {{ session()->get('privacy_page') == $language->code
                                                                ? 'selected' : '' }}
                                                                value="{{ $language->code }}">
                                                                {{ $language->name }}
                                                            </option>
                                                ...
                                                <textarea id="editor3"
                                                    class="form-control {{ $errors->has('privary_page') ? 'is-invalid' : '' }}"
                                                    rows="5"
                                            ...
                                            <div class="form-group mb-2">
                                                <div class="row d-flex justify-content-between items-align-center mb-2">
                                                    <div class="col-4">
                                                        ...
                                                        : loadDefaultLanguage();
                                                        @endphp
                                                        <select id="refund_policy_page_content" name="translation_code"
                                                            class="form-control select2 w-100  @error('translation_code') is-invalid @enderror">
                                                            @foreach ($languages as $key => $language)
                                                            <option {{ session()->get('refund_page') == $language->code
                                                                ? 'selected' : '' }}
                                                                value="{{ $language->code }}">
                                                                {{ $language->name }}
                                                            </option>
                                                ...
                                                <textarea id="editor4"
                                                    class="form-control {{ $errors->has('refund_page') ? 'is-invalid' : '' }}"
                                                    rows="5"
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            ...
                                            <input name="comingsoon_image" type="file" class="form-control dropify"
                    ...
                    {{-- maintenance_mode --}}
                    <div class="tab-pane {{ $tab_part == 'maintenance' ? 'show active' : '' }}" id="maintenance_mode">
                        <div class="card">
                            <div class="card-body">
                                <form class="form-horizontal" action="{{ route('settings.maintenance.mode.update') }}"
                                    method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="form">
                                        <label>{{ __('maintenance_image') }}<small class="text-danger">*</small></label>
                                    ...
                                    <div class="row row-cols-md-3">
                                        <div class="col-sm-3">
                                            <div class="card-body">
                                                ...
                                                <a href="{{ route('settings.paymentLogo.delete', 'payment_logo1') }}"
                                                    onclick="return confirm('{{ __('are_you_sure') }}')"
                                                    class="tw-underline">
                                                    <small>{{ __('delete_image') }}</small>
                                                </a>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="card-body">
                                                <input name="payment_logo2" type="file" class="form-control dropify"
                                                ...
                                                <a href="{{ route('settings.paymentLogo.delete', 'payment_logo2') }}"
                                                    onclick="return confirm('{{ __('are_you_sure') }}')"
                                                    class="tw-underline">
                                                    <small>{{ __('delete_image') }}</small>
                                                </a>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="card-body">
                                                <input name="payment_logo3" type="file" class="form-control dropify"
                                                ...
                                                <a href="{{ route('settings.paymentLogo.delete', 'payment_logo3') }}"
                                                    onclick="return confirm('{{ __('are_you_sure') }}')"
                                                    class="tw-underline">
                                                    <small>{{ __('delete_image') }}</small>
                                                </a>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="card-body">
                                                <input name="payment_logo4" type="file" class="form-control dropify"
                                                ...
                                                <a href="{{ route('settings.paymentLogo.delete', 'payment_logo4') }}"
                                                    onclick="return confirm('{{ __('are_you_sure') }}')"
                                                    class="tw-underline">
                                                    <small>{{ __('delete_image') }}</small>
                                                </a>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="card-body">
                                                <input name="payment_logo5" type="file" class="form-control dropify"
                                                ...
                                                <a href="{{ route('settings.paymentLogo.delete', 'payment_logo5') }}"
                                                    onclick="return confirm('{{ __('are_you_sure') }}')"
                                                    class="tw-underline">
                                                    <small>{{ __('delete_image') }}</small>
                                                </a>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="card-body">
                                                <input name="payment_logo6" type="file" class="form-control dropify"
                                                ...
                                                <a href="{{ route('settings.aboutLogo.delete', 'payment_logo6') }}"
                                                    onclick="return confirm('{{ __('are_you_sure') }}')"
                                                    class="tw-underline">
                                                    <small>{{ __('delete_image') }}</small>
                                                </a>
                    ...
                    <div class="tab-pane {{ $tab_part == 'others' ? 'show active' : '' }}" id="others">
                        <form class="form-horizontal" action="{{ route('settings.others.update') }}" method="POST"
                            ...
                            @method('PUT')
                            @csrf
                            <input type="hidden" class="form-control" name="othersid" placeholder="Enter Phone No...!!"
                                value="{{ $cms_setting->id }}">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            ...
                                            <p
                                                class="tw-text-gray-500 tw-text-xs tw-text-left mt-2 recommended-img-note mb-0">
                                                Recommended Image Size: 1296x580</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
