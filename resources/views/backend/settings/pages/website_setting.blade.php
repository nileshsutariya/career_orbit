                                        ...
                                        <div class="row row-cols-md-3">
                                            <div class="col-sm-3">
                                                <div class="card-body">
                                                    ...
                                                    <input name="about_brand_logo" type="file"
                                                        class="form-control dropify"
                                                        data-default-file="{{ asset($cms_setting->about_brand_logo) }}"
                                                        data-allowed-file-extensions='["jpg", "jpeg","png"]'>
                                                    <p
                                            ...
                                            <div class="col-sm-3">
                                                <div class="card-body">
                                                    <input name="about_brand_logo1" type="file"
                                                        class="form-control dropify"
                                            ...
                                            <div class="col-sm-3">
                                                <div class="card-body">
                                                    <input name="about_brand_logo2" type="file"
                                                        class="form-control dropify"
                                            ...
                                            <div class="col-sm-3">
                                                <div class="card-body">
                                                    <input name="about_brand_logo3" type="file"
                                                        class="form-control dropify"
                                            ...
                                            <div class="col-sm-3">
                                                <div class="card-body">
                                                    <input name="about_brand_logo4" type="file"
                                                        class="form-control dropify"
                                            ...
                                            <div class="col-sm-3">
                                                <div class="card-body">
                                                    <input name="about_brand_logo5" type="file"
                                                        class="form-control dropify"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="col-4">
                                                            ...
                                                            <select id="translation_code" name="translation_code"
                                                                class="form-control select2 @error('translation_code') is-invalid @enderror">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row row-cols-md-3">
                                            <div class="col-sm-3">
                                                <div class="card-body">
                                                    <input name="payment_logo1" type="file"
                                                        class="form-control dropify"
                                            ...
                                            <div class="col-sm-3">
                                                <div class="card-body">
                                                    <input name="payment_logo2" type="file"
                                                        class="form-control dropify"
                                            ...
                                            <div class="col-sm-3">
                                                <div class="card-body">
                                                    <input name="payment_logo3" type="file"
                                                        class="form-control dropify"
                                            ...
                                            <div class="col-sm-3">
                                                <div class="card-body">
                                                    <input name="payment_logo4" type="file"
                                                        class="form-control dropify"
                                            ...
                                            <div class="col-sm-3">
                                                <div class="card-body">
                                                    <input name="payment_logo5" type="file"
                                                        class="form-control dropify"
                                            ...
                                            <div class="col-sm-3">
                                                <div class="card-body">
                                                    <input name="payment_logo6" type="file"
                                                        class="form-control dropify"
