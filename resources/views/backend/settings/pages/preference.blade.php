                        ...
                        <div class="d-flex justify-content-between">
                            <div class="col-md-4">
                                <div class="form-check form-check-inline radio radio-primary">
                                    <input type="radio" id="live-mode" name="app_mode" class="form-check-input"
                            ...
                            <div class="col-md-4">
                                <div class="form-check form-check-inline radio radio-primary">
                                    <input type="radio" id="maintenance-mode" name="app_mode" class="form-check-input"
                            ...
                            <div class="col-md-4">
                                <div class="form-check form-check-inline radio radio-primary">
                                    <input type="radio" id="comingsoon-mode" name="app_mode" class="form-check-input"
                                        value="comingsoon" {{ config('app.mode') == 'comingsoon' ? 'checked' : '' }}>
                ...
                <form class="form-horizontal" action="{{ route('settings.system.jobdeadline.update') }}" method="POST">
                    ...
                    <div class="card-body applied-job-on">
                        <div class="d-flex justify-content-between">
                            <div class="col-md-4">
                                <div class="form-check form-check-inline radio radio-primary">
                                    <input type="radio" id="job_deadline_30" name="job_deadline_expiration_limit"
                                        class="form-check-input" value="30"
                                        {{ $setting->job_deadline_expiration_limit == 30 ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4">
                                <div class="form-check form-check-inline radio radio-primary">
                                    <input type="radio" id="job_deadline_60" name="job_deadline_expiration_limit"
                                        class="form-check-input" value="60"
                                        {{ $setting->job_deadline_expiration_limit == 60 ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4">
                                <div class="form-check form-check-inline radio radio-primary">
                                    <input type="radio" id="job_deadline_90" name="job_deadline_expiration_limit"
                                        class="form-check-input" value="90"
                                        {{ $setting->job_deadline_expiration_limit == 90 ? 'checked' : '' }}>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input class="tgl tgl-flip" data-bootstrap-switch value="1" name="status"
                                        ...
                                        {{ $setting->per_job_active == 1 ? 'checked' : '' }}>
                        ...
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    @enderror
                                    <small
                                        class="text-danger">{{ __('job_post_will_not_be_expired_anytime_soon_if_you_put') }}
                                        0</small>
                                </div>
                            </div>
                            <div class="col-sm-6">
