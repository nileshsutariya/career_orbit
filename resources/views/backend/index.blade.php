                        ...
                        <tr>
                            ...
                            <td class="text-muted">
                                <a href="{{ route('job.show', $latest->id) }}" class="btn  ml-1">
                                    <i class="fa fa-eye txt-secondary fa-2x"></i>
                                </a>
                            </td>
                        </tr>
                        @endforeach
                                ...
                                <td class="d-flex">
                                    ...
                                    <form action="{{ route('admin.transaction.invoice.download', $earning->id) }}"
                                        ...
                                        <button type="submit" class="btn">
                                            <i class="txt-warning fa fa-download fa-2x"></i>
                                        </button>
                                    </form>
                                </td>
                            </tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="d-flex">
                                    ...
                                    <a href="{{ route('company.show', $user->company->id) }}" class="btn  mr-1">
                                        <i class="fa fa-eye txt-secondary fa-2x"></i>
                                    </a>
                                    @else
                                    -
                                    ...
                                    <a href="{{ route('candidate.show', $user->candidate->id) }}" class="btn  mr-1">
                                        <i class="fa fa-eye txt-secondary fa-2x"></i>
                                    </a>
                                    @else
                                    -
