                    ...
                    <div class="card-header pb-0 card-no-border">
                        <div class="d-flex justify-content-between flex-sm-row flex-column">
                            <div class="pb-3 pb-md-0">
                                <h4 class="title">{{ __('job_role_list') }} ({{ count($jobRoles) }})</h4>
                            </div>
                            <div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="float-start">
                                <h4>{{ __('edit') }} {{ 'job Role' }}</h4>
                            </div>
                            <div class="float-end">
                                <a href="{{ route('jobRole.index') }}" class="btn btn-primary"><i
                        ...
                        <div class="card-body">
                            ...
                            <form class="row g-3" action="{{ route('jobRole.update', $jobRole->id) }}" method="POST">
                                @method('PUT')
                                @csrf
                                @foreach ($app_language as $key => $language)
                                    @php
                                ...
                                <div class="col-12">
                                    <button class="btn btn-primary" type="submit"><i class="fa fa-refresh   "> </i>
                                        {{ __('save') }} </button>
                                </div>
                            </form>
        ...
        <div class="modal fade" id="tooltipmodal" tabindex="-1" role="dialog" aria-labelledby="tooltipmodal"
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('admin.job.role.bulk.import') }}" method="post"
                        enctype="multipart/form-data">
                        @csrf
