                ...
                <div class="card">
                    <div class="card-header">
                        <div class="float-start">
                            <h3>{{ __('update_page') }}</h3>
                        </div>
                        <div class="float-end">
                            <a href="{{ route('settings.pages.index') }}" class="btn bg-primary">
                                <i class="fa fa-arrow-left"></i>
                                {{ __('back') }}
                            </a>
                        </div>
                    </div>
                    <form class="form-horizontal" action="{{ route('settings.pages.update', $page->id) }}" method="POST"
                            ...
                            <div class="mb-2 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="title" id="title"
                                        ...
                                        value="{{ old('title', $page->title) }}" placeholder="{{ __('title') }}"
                                        required>
                                    @error('title')
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" name="slug" id="slug"
                                            ...
                                            value="{{ old('slug', $page->slug) }}" placeholder="slug" required>
                                    </div>
                            ...
                            <div class="mb-2 row">
                                ...
                                <div class="col-sm-10">
                                    <select name="footer_column_position" id="footer_column_position"
                                        ...
                                        <option value="1"
                                            {{ old('footer_column_position', $page->footer_column_position) == 1 ? 'selected' : '' }}>
                                            {{ __('company') }}</option>
                                        <option value="2"
                                            {{ old('footer_column_position', $page->footer_column_position) == 2 ? 'selected' : '' }}>
                                            {{ __('candidate') }}</option>
                                        <option value="3"
                                            {{ old('footer_column_position', $page->footer_column_position) == 3 ? 'selected' : '' }}>
                                            {{ __('employer') }}</option>
                                        <option value="4"
                                            {{ old('footer_column_position', $page->footer_column_position) == 4 ? 'selected' : '' }}>
                                            {{ __('support') }}</option>
                                    </select>
