                    ...
                    <div class="card-body">
                        <div class="row">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="basic-addon3">{{ route('website.home')
                                                }}/</span>
                                        </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <select name="footer_column_position" id="footer_column_position"
                                        ...
                                        required>
                                        <option value="1" {{ old('footer_column_position')==1 ? 'selected' : '' }}>
                                            {{ __('company') }}</option>
                                        <option value="2" {{ old('footer_column_position')==2 ? 'selected' : '' }}>
                                            {{ __('candidate') }}</option>
                                        <option value="3" {{ old('footer_column_position')==3 ? 'selected' : '' }}>
                                            {{ __('employer') }}</option>
                                        <option value="4" {{ old('footer_column_position')==4 ? 'selected' : '' }}>
                                            {{ __('support') }}</option>
                                    </select>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input type="file" class=" dropify" data-default-file="" name="meta_image"
