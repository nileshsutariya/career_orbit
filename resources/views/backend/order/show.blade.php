                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-12">
                                    ...
                                    <p class="mb-0">{{ __('price') }}:
                                        <strong>
                                            {{ currencyPosition(currencyConversion($order->usd_amount, 'USD')) }}
                                        </strong>
                                    </p>
                                </div>
                                <div class="col-md-12 col-lg-12 mt-5">
                                    ...
                                    <p class="mb-1">{{ __('candidate_cv_preview_limit') }}:
                                        <strong>{{ $order->plan->candidate_cv_view_limitation == 'limited' ? $order->plan->candidate_cv_view_limit : __('unlimited') }}
                                            {{ __('times') }}</strong>
                                    </p>
                                </div>
                            </div>
