                ...
                <div class="card-header pb-0 card-no-border">
                    <div class="d-flex justify-content-between flex-sm-row flex-column">
                        <div class="pb-3 pb-md-0">
                            <h4 class="title">{{ __('industry_types_list') }} ({{ $industrytypes ? count($industrytypes)
                                : '0' }})</h4>
                        </div>
                        <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a href="{{ route('industryType.edit', $industrytype->id) }}" class="btn">
        ...
        <div class="col-md-4">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="float-end">
                        <a href="{{ route('industryType.index') }}" class="btn btn-primary"><i class="fa fa-plus"></i>{{
                            __('create') }}
                        </a>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    <form class="row g-3" action="{{ route('industryType.update', $industryType->id) }}" method="POST">
                        @method('PUT')
                        @csrf
                        @foreach ($app_language as $key => $language)
                        @php
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-md-12 mb-2">
                            ...
                            <div class="d-grid gap-2">
                                <a href="/backend/dummy/industry_example.xlsx" target="_blank" class="btn btn-primary">
