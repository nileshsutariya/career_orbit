                            ...
                            @if (userCan('job_category.create'))
                                <form class="row g-3" action="{{ route('jobCategory.store') }}" method="POST"
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input name="image" class="form-control" autocomplete="image" type="file"
                                            id="image">
                                    </div>
                                    <div class="col-md-12">
                                        <div>
                ...
                @if (!empty($jobCategory) && userCan('job_category.update'))
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="float-end">
                                <a href="{{ route('jobCategory.index') }}" class="btn btn-primary"><i
                        ...
                        <div class="card-body">
                            ...
                            <form class="row g-3" action="{{ route('jobCategory.update', $jobCategory->id) }}"
