            ...
            <div class="card-header">
                <div class="d-flex justify-content-between">
                    ...
                    <div>
                        ...
                        <a href="{{ route('candidate.create') }}" class="btn bg-primary"><i class="fa fa-plus mr-1"></i>
                            {{ __('create') }}
                        </a>
                        @endif
                        @if (request('keyword') || request('ev_status') || request('sort_by'))
                        <a href="{{ route('company.index') }}" class="btn bg-danger"><i class="fa fa-times"></i>&nbsp;
                            {{ __('clear') }}
                        </a>
                        @endif
                    </div>
                        ...
                        <tr>
                            <td tabindex="0">
                                <a href="{{ route('candidate.show', $candidate->id) }}" class="company">
                                    <img src="{{ $candidate->photo }}" class="img-fluid table-avtar" alt="image">
                                    <div>
                                    ...
                                    <div class="form-check-size">
                                        <div class="form-check form-switch form-check-inline">
                                            <input
                                                ...
                                                data-id="{{ $candidate->user_id }}" {{ $candidate->user->status == 1 ?
                                            'checked' : '' }} type="checkbox" role="switch" checked="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-check-size">
                                        <div class="form-check form-switch form-check-inline">
                                            <input
                                                ...
                                                $candidate->user->email_verified_at ? 'checked' : '' }} type="checkbox"
                                            role="switch" checked="">
                                        </div>
                                    </div>
