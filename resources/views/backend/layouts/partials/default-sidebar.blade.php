...
<div class="sidebar-wrapper" data-layout="stroke-svg">
    <div>
        <div class="logo-wrapper">
            <div class="d-flex">
                <img class="img-fluid" src="{{ $setting->favicon_image_url }}" width="25%" alt="{{ __('logo') }}" />
        ...
        <nav class="sidebar-main">
            ...
            <div id="sidebar-menu">
                <ul class="sidebar-links mb-2" id="simple-bar">
                    ...
                    @if (userCan('job.view'))
                        <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                class="sidebar-link sidebar-title link-nav {{ Request::is('admin/job/*') || Request::is('admin/job') || request()->routeIs('admin.job.edited.*')
                                    ? 'active'
                                    : 'nav' }}"
                    ...
                    @if (userCan('job.view'))
                        <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                class="sidebar-link sidebar-title link-nav  {{ Request::is('admin/applied/jobs/*') ||
                                Request::is('admin/applied/jobs') ||
                                request()->routeIs('admin.applied.jobs*')
                                    ? 'active'
                                    : 'nav' }}"
                                href="{{ route('applied.jobs') }}">
                    ...
                    @if (Module::collections()->has('Plan') && userCan('plan.view'))
                        <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                class="sidebar-link sidebar-title link-nav {{ Route::is('module.plan.index') || Route::is('module.plan.create') || Route::is('module.plan.edit')
                                    ? 'active'
                                    : 'nav' }}"
                                href="{{ route('module.plan.index') }}">
                    ...
                    @if (userCan('industry_types.view') || userCan('professions.view'))
                        <li
                            class="sidebar-list {{ Request::is('admin/industryType*') ||
                            ...
                            <i class=" fa fa-thumb-tack"></i><a
                                class="sidebar-link sidebar-title {{ Request::is('admin/industryType*') ||
                                Request::is('admin/profession*') ||
                                Request::is('skill.*') ||
                                Request::routeIs('tags.*') ||
                                request()->routeIs('benefit.*') ||
                            ...
                            <ul class="sidebar-submenu ">
                                @if (userCan('industry_types.view'))
                                    <li><a href="{{ route('industryType.index') }}"
                                            class="  {{ Request::is('admin/industryType*') ? 'active' : 'nav' }}">{{ __('industry_type') }}
                                        </a>
                                    </li>
                                @endif
                    ...
                    @if (Module::collections()->has('Testimonial') && userCan('testimonial.view'))
                        <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                class="sidebar-link sidebar-title link-nav {{ Route::is('module.testimonial.index') ||
                                Route::is('module.testimonial.create') ||
                                Route::is('module.testimonial.edit')
                                    ? 'active'
                                    : 'nav' }} "
                                href="{{ route('module.testimonial.index') }}">
                    ...
                    @if (userCan('faq.view'))
                        <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                class="sidebar-link sidebar-title link-nav {{ Route::is('module.faq.index') ||
