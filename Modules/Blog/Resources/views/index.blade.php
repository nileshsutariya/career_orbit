                    ...
                    <div class="card-header pb-0 card-no-border">
                        ...
                        <div class="float-end">
                            @if (request('keyword') ||
                                    ...
                                    request('status') ||
                                    request('sort_by'))
                                <a href="{{ route('module.blog.index') }}" class="btn btn-danger"><i
                                    ...
                                    @forelse ($blogs as $post)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <span
                                                    class="{{ $post->status == 'draft' ? 'badge badge-danger' : 'badge badge-success' }} rounded f-16
                                                    ">
                                                    {{ $post->status }}
                                                </span>
                                            </td>
                                            <td class="d-flex align-items-center">
                                                ...
                                                @if (userCan('post.update'))
                                                    <a data-bs-toggle="tooltip" data-bs-placement="top"
                                                        data-bs-title="Edit" title="{{ __('edit') }}"
                                                        href="{{ route('module.blog.edit', $post->id) }}" class="btn">
