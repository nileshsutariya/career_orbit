    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card">
                ...
                <form class="form theme-form" action="{{ route('module.testimonial.store') }}" method="POST"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input name="image" autocomplete="image"
                                            ...
                                            type="file"class="form-control form-control-sm @error('image') is-invalid @enderror"
                                            id="customFile">
                                        ...
                                        @foreach ($app_languages as $lang)
                                            <div class="form-check form-check-inline radio radio-primary">
                                                <input class="form-check-input" type="radio"
                                                    ...
                                                    value="{{ $lang->code }}">
                                                <label class="form-check-label mb-0 text-dark"
                                                    for="lang_code_{{ $lang->id }}">{{ $lang->name }}</label>
                                            </div>
                                        @endforeach
                                        @error('code')
                                            <span
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea rows="8" type="text" class="form-control" name="description" placeholder="{{ __('description') }}">{{ old('description') }}</textarea>
                                        @error('description')
