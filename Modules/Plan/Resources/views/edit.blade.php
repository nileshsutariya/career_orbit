                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input
                                                            {{ old('candidate_cv_view_limitation', $plan->candidate_cv_view_limitation) == 'limited' ? 'checked' : '' }}
                                                    ...
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input
                                                            {{ old('candidate_cv_view_limitation', $plan->candidate_cv_view_limitation) == 'unlimited' ? 'checked' : '' }}
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio" id="show_frontend_yes" name="frontend_show"
                                                            ...
                                                            value="1" {{ $plan->frontend_show ? 'checked' : '' }}>
                                                        <label class="custom-control-label"
                                                    ...
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio" id="show_frontend_no" name="frontend_show"
                                                            class="plan_type_selection custom-control-input"
                                                            value="0" {{ !$plan->frontend_show ? 'checked' : '' }}>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio" id="profile_verify_yes"
                                                            name="profile_verify"
                                                            class="plan_type_selection custom-control-input"
                                                            value="1" {{ $plan->profile_verify ? 'checked' : '' }}>
                                                        <label class="custom-control-label"
                                                    ...
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio" id="profile_verify_no"
                                                            name="profile_verify"
                                                            class="plan_type_selection custom-control-input"
                                                            value="0" {{ !$plan->profile_verify ? 'checked' : '' }}>
                                            ...
                                            @foreach ($app_languages as $app_language)
                                                @php
                                                    ...
                                                    $plan_description =
                                                        $plan->descriptions
                                                            ->where('locale', $app_language->code)
                                                            ->first() ?? '';
                                                @endphp
                                                <div class="col-md-12">
                                                    <div class="form-group">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="float-start">
                                <h3>{{ __('edit') }} {{ __('plan') }}</h3>
                            </div>

                            <div class="float-end">
                                <a href="{{ route('module.plan.index') }}" class="btn btn-primary">
                            ...
                            <form action="{{ route('module.plan.update', $plan->id) }}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <label class="form-label" for="price">{{ __('price') }}
                                            {{ defaultCurrencySymbol() }}<small class="text-danger">*</small></label>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <label class="form-label" for="job_limit">{{ __('job_limit') }}
                                            <small class="text-danger">*</small></label>
                                        <input type="number" id="job_limit" name="job_limit"
                                            value="{{ $plan->job_limit }}"
                                            class="form-control @error('job_limit') is-invalid @enderror"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-check form-check-inline radio radio-primary">
                                            ...
                                            <label class="form-check-label mb-0" for="unlimited_profile_view">
                                                {{ __('unlimited') }}
                                            </label>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-check form-check-inline radio radio-primary">
                                            <input type="radio" id="show_frontend_yes" name="frontend_show"
                                                class="plan_type_selection form-check-input" value="1"
                                                {{ $plan->frontend_show ? 'checked' : '' }}>
                                            <label class="form-check-label mb-0"
                                                for="show_frontend_yes">{{ __('yes') }}</label>
                                        </div>
                                        <div class="form-check form-check-inline radio radio-primary">
                                            <input type="radio" id="show_frontend_no" name="frontend_show"
                                                class="plan_type_selection form-check-input" value="0"
                                                {{ !$plan->frontend_show ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-check form-check-inline radio radio-primary">
                                                <input type="radio" id="profile_verify_yes" name="profile_verify"
                                                    class="plan_type_selection form-check-input" value="1"
                                                    {{ $plan->profile_verify ? 'checked' : '' }}>
                                                <label class="form-check-label mb-0"
                                                    for="profile_verify_yes">{{ __('yes') }}</label>
                                            </div>
                                            <div class="form-check form-check-inline radio radio-primary">
                                                <input type="radio" id="profile_verify_no" name="profile_verify"
                                                    class="plan_type_selection form-check-input" value="0"
                                                    {{ !$plan->profile_verify ? 'checked' : '' }}>
                                    ...
                                    @foreach ($app_languages as $app_language)
                                        @php
                                            $name = "description_{$app_language->code}";
                                            $plan_description =
                                                $plan->descriptions->where('locale', $app_language->code)->first() ??
                                                '';
                                        @endphp
                                        <div class="col-md-12">
                                            <div class="form-group">
